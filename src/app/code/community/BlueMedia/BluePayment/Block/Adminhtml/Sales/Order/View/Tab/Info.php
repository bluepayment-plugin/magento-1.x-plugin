...
class BlueMedia_BluePayment_Block_Adminhtml_Sales_Order_View_Tab_Info
    extends Mage_Adminhtml_Block_Sales_Order_View_Tab_Info
{
    public function getPaymentHtml()
    {
        ...
        if ($payment == 'bluepayment') {
            ...
            $additionaPaymentInfo = '</br><span class="bluemedia-bluepayment-order-info">'
                . Mage::helper('bluepayment')->__('Selected gateway ID: ' . $gatewayId)
                . '</span>';
